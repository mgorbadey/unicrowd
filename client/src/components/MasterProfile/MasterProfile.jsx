...
export default function MasterProfile() {
    ...
    // useEffect - который при запросе на эту ручку будет доставать из бд всю информацию, чтобы отрисовывать профиль

    React.useEffect(() => {
        async function getUserInfo() {
            const userInfo = await axios.get(`http://localhost:3500/master/${params.id}/profile`)
            ...
            <div className="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div className="ml-4 mt-4">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <h3 className="text-lg leading-6 font-medium text-gray-900">{info?.data?.name}</h3>
                        </div>
                    </div>
                </div>
            ...
            <form className="space-y-8 divide-y divide-gray-200">
                <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                            ...
                            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div className="mt-1 sm:mt-0 sm:col-span-2">
                                    <div className="flex items-center">
                                        ...
                                        <input type="file" className="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" onChange={e => setImg(e.target.files[0])}/>
                                        <button
                                            type="button"
                    ...
                    <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                        <div>
                            <h3 className="text-lg leading-6 font-medium text-gray-900">Персональная информация</h3>
                        </div>
