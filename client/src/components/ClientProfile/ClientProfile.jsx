...
export default function MasterProfile() {
  ...
  // function clientDeleteEvent() {
  //   console.log(dataEvents, dataEvents.id)
  //   $api
  //     .delete(`http://localhost:3500/masters/${dataEvents.masterId}/events/${dataEvents.id}`)
  //     .then((response) => {
